...
public class MoveRightCommand extends Command {
    ...
    public MoveRightCommand(Robot robot, Game myGame) {
        ...
        walk = new ImageIcon(getClass().getResource("/recursos/images/walkRight.png")).getImage();
        fly = new ImageIcon(getClass().getResource("/recursos/images/flyright.png")).getImage();
